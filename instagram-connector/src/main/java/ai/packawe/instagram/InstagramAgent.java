package ai.packawe.instagram;

import static ai.packawe.instagram.utils.Constants.ACCESS_TOKEN_ARG_NAME;
import static ai.packawe.instagram.utils.Constants.ACCESS_TOKEN_PROP_NAME;
import static ai.packawe.instagram.utils.Constants.ACCESS_TOKEN_SECRET_ARG_NAME;
import static ai.packawe.instagram.utils.Constants.ACCESS_TOKEN_SECRET_PROP_NAME;
import static ai.packawe.instagram.utils.Constants.AGENT_CONF_FILE_ARG_NAME;
import static ai.packawe.instagram.utils.Constants.API_KEY_ARG_NAME;
import static ai.packawe.instagram.utils.Constants.API_KEY_PROP_NAME;
import static ai.packawe.instagram.utils.Constants.API_SECRETS_ARG_NAME;
import static ai.packawe.instagram.utils.Constants.API_SECRETS_PROP_NAME;
import static ai.packawe.instagram.utils.Constants.CALLBACK_URL_ARG_NAME;
import static ai.packawe.instagram.utils.Constants.CALLBACK_URL_PROP_NAME;
import static ai.packawe.instagram.utils.Constants.DAEMON_MODE_ARG_NAME;
import static ai.packawe.instagram.utils.Constants.FETCH_INTERVAL_ARG_NAME;
import static ai.packawe.instagram.utils.Constants.FETCH_INTERVAL_PROP_NAME;
import static ai.packawe.instagram.utils.Constants.KAFKA_BROKER_LIST_ARG_NAME;
import static ai.packawe.instagram.utils.Constants.KAFKA_BROKER_LIST_PROP_NAME;
import static ai.packawe.instagram.utils.Constants.KAFKA_PRODUCER_CONF_FILE_ARG_NAME;
import static ai.packawe.instagram.utils.Constants.KAFKA_TOPIC_ARG_NAME;
import static ai.packawe.instagram.utils.Constants.KAFKA_TOPIC_PROP_NAME;
import static ai.packawe.instagram.utils.Constants.OPLOG_FILE_ARG_NAME;
import static ai.packawe.instagram.utils.Constants.OPLOG_FILE_PROP_NAME;
import static ai.packawe.instagram.utils.Constants.TAGS_ARG_NAME;
import static ai.packawe.instagram.utils.Constants.TAGS_PROP_NAME;
import static ai.packawe.instagram.utils.Constants.USERS_ARG_NAME;
import static ai.packawe.instagram.utils.Constants.USERS_PROP_NAME;
